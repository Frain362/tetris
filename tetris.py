...
game_sc = Canvas(tk, width=W*TILE+1, height=H*TILE+1, bg="green", highlightthickness=0)
...
sc.create_text(505, 30, text="TETRIS!", font=("Arial", 44), fill="blue", anchor=NW)
sc.create_text(535, 780, text="score:", font=("Arial", 44), fill="red", anchor=NW)
_score = sc.create_text(550, 840, text=str(score), font=("Arial", 40), fill="red", anchor=NW)
sc.create_text(525, 650, text="record:", font=("Arial", 44), fill="gold", anchor=NW)
_record = sc.create_text(550, 710, text=record, font=("Arial", 40), fill="gold", anchor=NW)
